//=================================================================================
//功    能：使控件尺寸随着主对话框尺寸按比例调整
//命名空间：Common
//类    名：AutoControlSize
//使用方法：
//          1.添加AutoControlSize.cs文件到工程.
//          2.引用Common命名空间.
//          3.将"AutoControlSize.RegisterFormControl(this);"添加到Form的构造函数里控件初始化之后.
//          4.将"AutoControlSize.ChangeFormControlSize(this);" 添加到Form的Resize消息响应函数中.
//
//初次创建：liyang 20151122
//=================================================================================
using System;
